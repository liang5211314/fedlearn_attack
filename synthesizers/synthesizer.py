...
class Synthesizer:
    ...
    def make_backdoor_batch(self, batch: Batch, test=False, attack=True) -> Batch:
        ...
        self.apply_backdoor(backdoored_batch, test, attack_portion)
    ...
    def apply_backdoor(self, batch,test, attack_portion):
        """
        ...
        :return:
        """
        self.synthesize_inputs(batch=batch,test=test, attack_portion=attack_portion)
        self.synthesize_labels(batch=batch, attack_portion=attack_portion)

        return

    def synthesize_inputs(self, batch,test, attack_portion=None):
